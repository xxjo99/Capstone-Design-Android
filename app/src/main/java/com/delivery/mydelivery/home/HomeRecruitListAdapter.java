...
public class HomeRecruitListAdapter extends RecyclerView.Adapter<HomeRecruitListAdapter.ViewHolder> {
    ...
    // 생성자
    public HomeRecruitListAdapter(List<RecruitVO> recruitList, Context context) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HomeRecruitListAdapter.ViewHolder holder, int position) {
    ...
    // 매장이름 지정
    private void setStoreName(int storeId, HomeRecruitListAdapter.ViewHolder holder) {
    ...
    // 등록자 지정
    private void setRegistrantName(int userId, HomeRecruitListAdapter.ViewHolder holder) {
        retrofitService = new RetrofitService();
    ...
    private void checkParticipate(int participateUserId, int recruitId, HomeRecruitListAdapter.ViewHolder holder, int person, String place, String deliveryTime, int storeId) {
        retrofitService = new RetrofitService();
        recruitApi = retrofitService.getRetrofit().create(RecruitApi.class);
    ...
    // 이용제한 확인
    private void checkRestriction(int participateUserId, int recruitId, HomeRecruitListAdapter.ViewHolder holder, int person, String place, String deliveryTime, int storeId) {
        retrofitService = new RetrofitService();
        userApi = retrofitService.getRetrofit().create(UserApi.class);
    ...
    // 모집글 상세 다이얼로그 생성
    private void createDialog(int participateUserId, int recruitId, HomeRecruitListAdapter.ViewHolder holder, int recruitPerson, String place, String deliveryTime, int storeId) {
