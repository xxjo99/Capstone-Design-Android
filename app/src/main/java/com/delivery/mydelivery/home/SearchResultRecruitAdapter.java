...
public class SearchResultRecruitAdapter extends RecyclerView.Adapter<SearchResultRecruitAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_search_recruit, parent, false);
    ...
    // 이용제한 확인
    private void checkParticipationRestriction(int participateUserId, int recruitId, SearchResultRecruitAdapter.ViewHolder holder, int person, String place, String deliveryTime, int storeId) {
        retrofitService = new RetrofitService();
        userApi = retrofitService.getRetrofit().create(UserApi.class);
